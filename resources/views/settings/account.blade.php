...
<head>
    ...
    <style>
        ...
        .main-content {
            margin-left: 200px; /* Asegura que el contenido principal se ajuste a la barra lateral */
            padding: 20px;
            width: calc(100% - 200px); /* Ajusta el ancho para que no se sobreponga a la barra lateral */
            max-width: 1000px; /* Límite de ancho máximo */
...
<div class="main-content">
    <div class="config-container">
        ...
        <p>Asegúrate de que tus datos personales estén correctos.</p>
